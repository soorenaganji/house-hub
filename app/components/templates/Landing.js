...
const Landing = () => {
  return (
    <div className="flex flex-col gap-16 -mt-24  ">
      <div className=" bg-gradient-to-b from-[#e0defb]  via-teal-50 via-30% to-transparent pt-8 px-4 md:via-inherit md:from-[#e0defb7d] md:bg-[#F7F7FD] md:to-[#e0defb] min-h-screen">
        <HeroSection />
      </div>
